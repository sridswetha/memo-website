...
export default function About() {
  return (
    <div className="px-25 py-30"  style={{ backgroundColor: '#DBF9FF',     textShadow: '2px 2px 6px rgba(0,0,0,0.3)'     }}>
      <h1 className="text-3xl font-bold text-[#0E1E3D] tracking-wider flex justify-center" style={{ fontFamily: 'UpheavalTT, Arial, sans-serif', fontSize: '150px'}}>About</h1>
      <div className="flex flex-wrap justify-center gap-8 py-12">
        <FlipCard
          ...
          className="w-1/2 md:w-1/3 min-w-[300px]"
        />
        <FlipCard
          name="Siya Kothale"
